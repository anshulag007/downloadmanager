...
class MainApp(QMainWindow, ui):
    ...
    def Handle_Browse(self):
        ## enable browsing to our os, so taht we can pick save location
    ...
    def Move_Box_3(self):
        box_animation3 = QPropertyAnimation(self.groupBox_5, b"geometry")
    ...
    def Move_Box_4(self):
        box_animation4 = QPropertyAnimation(self.groupBox_6, b"geometry")
